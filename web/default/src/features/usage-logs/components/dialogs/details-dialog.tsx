...
import type { LogDetail, LogOtherData } from '../../types'
...
export function DetailsDialog(props: DetailsDialogProps) {
  ...
  const logDetail = logDetailQuery.data?.success
    ...
    : undefined
  const logDetailErrorMessage = logDetailQuery.isError
    ? t('Failed to load request and response details')
    : logDetailQuery.data && !logDetailQuery.data.success
