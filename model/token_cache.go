...
redis.call('HSET', KEYS[1],
  ...
  'AutoGroups', ARGV[14], 'LogDetailEnabled', ARGV[15],
  'RemainQuota', ARGV[16], 'UsedQuota', ARGV[17])
redis.call('EXPIRE', KEYS[1], ARGV[18])
return 1`
	...
	return common.RDB.Eval(context.Background(), script, []string{
		...
		token.AutoGroups, strconv.FormatBool(token.LogDetailEnabled), token.RemainQuota, token.UsedQuota,
