...
type Token struct {
	...
	LogDetailEnabled   bool           `json:"log_detail_enabled"` // 仅为该令牌采集请求/响应详情
...
func (token *Token) Update() (err error) {
	...
	err = DB.Model(token).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota",
		"model_limits_enabled", "model_limits", "allow_ips", "group", "cross_group_retry", "log_detail_enabled").Updates(token).Error
	return err
}
